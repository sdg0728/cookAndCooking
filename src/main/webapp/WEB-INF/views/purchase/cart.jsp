...
<body>
    ...
    <section>
        <div class="content-wrap">
            <h3 class="black" style="margin-top: 20px;">장바구니</h3>
            <table id="table" class="table">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th scope="col">수량</th>
                        <th scope="col">금액</th>
                        <th scope="col" class="clear">전체 비우기</th>
                    </tr>
                </thead>
                <tbody id="tbody">
            ...
            <div class="btn-wrap">
                <a href="${pageContext.request.contextPath }/purchase/buy"><button type="button" class="btn btn-dark">구매하기</button></a>
                <a href="${pageContext.request.contextPath }/purchase/rlist"><button type="button" class="btn btn-dark">목록으로</button></a>
            </div>
        </div>
    </section>
    ...
    <script src="${pageContext.request.contextPath }/resources/purchase/JS/cart.js"></script>
