...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/purchase/CSS/recipe_product_list.css?<%=System.currentTimeMillis()%>">
...
<body>
    ...
    <section>
        <div class="content-wrap">
            <h3 class="black" style="margin-top: 20px;">구매목록</h3>
    ...
    <script src="${pageContext.request.contextPath }/resources/purchase/JS/orders.js"></script>
