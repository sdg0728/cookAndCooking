...
<body>
	...
	<section id="sign_secA">
		<div class="container">
			...
			<form method="post" action="${pageContext.request.contextPath }/member/user_deleteOk?${_csrf.parameterName}=${_csrf.token}" name="delete" onsubmit="return check()">
            ...
            <button type="submit" id="btn_delete"  class="btn btn-success">회원 탈퇴</button>
...
<script src="${pageContext.request.contextPath }/resources/member/JS/membership_withdrawal.js?ver=<%= System.currentTimeMillis()%>" type="text/javascript"></script>
