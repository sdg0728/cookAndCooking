...
<!DOCTYPE html>
    ...
    <head>
     ...
     <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700" rel="stylesheet" type="text/css">
      ...
      <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/font-awesome.min.css">
		...
		<!-- allRecipeCSS -->
		<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/userRecipe/CSS/uploadRecipe.css">
    ...
    <body>
     ...
     <div class="tt">
      <section>
          	<form action="editorRecipeOk?${_csrf.parameterName }=${_csrf.token }" enctype="multipart/form-data" method="POST">
          ...
          <input type="hidden" name="user_rid" id="user_rid" value="${user_rid }"/> 
            <div>
              <hr>
               ...
               <input class="recipe_Uploadname" type="text" name="name" id="" value="${result[0].name} " placeholder="레시피를 입력해주세요">
            ...
            <div>
                ...
                <!--  이미지 값 받아오기 -->
                 		<input type="hidden" name="img" value="${result[0].img}">	
            ...
            <div>
                ...
                <div id="plusbox2" >
                 	<c:forEach  items="${fn:split(result[0].ingredient, ',') }" var="item">
            ...
            <div>
                ...
                <input type="hidden" name="recipe_1" id="recipe_1"> 
                <input type="hidden" name="recipe_2" id="recipe_2"> 
                <input type="hidden" name="recipe_3" id="recipe_3"> 
                <input type="hidden" name="recipe_4" id="recipe_4"> 
                <input type="hidden" name="recipe_5" id="recipe_5"> 
                <input type="hidden" name="recipe_6" id="recipe_6"> 
                <input type="hidden" name="recipe_7" id="recipe_7"> 
                <input type="hidden" name="recipe_8" id="recipe_8"> 
                <input type="hidden" name="recipe_9" id="recipe_9"> 
                <input type="hidden" name="recipe_10" id="recipe_10"> 
                <div class="mar dis">
