...
<!DOCTYPE html>
    ...
    <body>
     ...
     <div class="tt">
      <section>
          <form action="uploadRecipeOk?${_csrf.parameterName }=${_csrf.token }" enctype="multipart/form-data" method="POST">
          <input type="hidden" name="email" id="email" value="${email }"/> 
            ...
            <hr>
                ...
                <div>
                    <input type="submit" class="btn btn-success submit-btn" value="등록">
                </div>
         </form>
      </section>
    </div>
