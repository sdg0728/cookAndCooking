...
<!DOCTYPE html>
    ...
    <head>
		...
		<!-- allRecipeCSS -->
		<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/userRecipe/CSS/adminWarningRecipe.css">
					...
					<div class="modal-dialog modal-center modal-dialog-scrollable">
						<div id="modal_size" class="modal-content ">
							...
							<div class="modal-header">
								...
								<form action="notifydeleteOk?${_csrf.parameterName }=${_csrf.token }" enctype="multipart/form-data" method="POST">
