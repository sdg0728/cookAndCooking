...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/purchase/CSS/apply_prod_detail.css">
...
<body>
    ...
    <section>
        <div class="content-wrap">
            ...
            <form name="add-prod-frm" action="" method="POST">
                <div class="prod-info-wrap">
                    <div class="prod-img">
                        <img src="${pageContext.request.contextPath }/resources/purchase/image/sample_img.jpg" />
                    </div>
                    <div class="prod-info">
                        <div class="info">
                            <div class="prod-name black">
                                <div class="name">핫도그</div>
                            </div>
                            <div class="prod-price black">
                                <div class="price">4000</div>
                            </div>
                            <div class="prod-cate black">
                                <div class="category">한식</div>
                            </div>
                            <div class="prod-content black">
                                <div class="content">쫀득쫀득 맛있는 핫도그~~ 너무너무 맛있어요~~~</div>
                            </div>
                        </div>
                        <div class="prod-count black">
                            <div class="count">100</div>
                        </div>
                        <div class="button-wrap">
                            <button type="button" class="btn btn-dark">승인확인</button>
                        </div>
                    </div>
                </div>
            </form>
